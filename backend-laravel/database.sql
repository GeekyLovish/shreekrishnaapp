...
--
-- Host: localhost:3306
-- Generation Time: Nov 08, 2025 at 08:57 PM
...
--
-- Database: `raman_jaishrikrishna_production`
--

-- --------------------------------------------------------

--
-- Table structure for table `aartis`
--
...
CREATE TABLE `audio` (
  ...
  `type` enum('bhajan','ringtone') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `comment` (
  ...
  `postType` enum('gallery','amrit') COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `comment_likes` (
  `id` bigint UNSIGNED NOT NULL,
  `type` enum('like','love') COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` bigint UNSIGNED NOT NULL,
  `post_id` bigint UNSIGNED NOT NULL,
...
--
-- Table structure for table `geeta_parts`
--

CREATE TABLE `geeta_parts` (
  `id` bigint UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `old_users` (
  ...
  `block` enum('1','0') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  `verify_phone` enum('no','yes') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no',
...
CREATE TABLE `posts` (
  `id` bigint UNSIGNED NOT NULL,
  `type` enum('gallery','amrit') COLLATE utf8mb4_unicode_ci NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `link_type` enum('page','learn','web','watch') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `reply` (
  ...
  `postType` enum('gallery','amrit') COLLATE utf8mb4_general_ci NOT NULL,
  `comment` longtext COLLATE utf8mb4_general_ci NOT NULL,
  `comment_phone_number` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `videos` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `type` enum('youtube') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `geeta_parts`
--
ALTER TABLE `geeta_parts`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pictures`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pictures_part_id_foreign` (`part_id`);
...
--
-- AUTO_INCREMENT for table `aartis`
--
ALTER TABLE `aartis`
...
--
-- AUTO_INCREMENT for table `geeta_parts`
--
ALTER TABLE `geeta_parts`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `comment_likes`
  ...
  ADD CONSTRAINT `comment_likes_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
...
--
ALTER TABLE `pictures`
  ADD CONSTRAINT `pictures_part_id_foreign` FOREIGN KEY (`part_id`) REFERENCES `parts` (`id`);
