...
import com.raman.kumar.shrikrishan.fbreaction.PopupGravity.*
    ...
    private var currentState: ReactionViewState? = null
        set(value) {
            ...
            when (value) {
                ...
                null -> {
                    // Handle the null state, for example by resetting animations or clearing selection
...
//            dialogX = max(0, (width - dialogWidth) / 2)
            val i = (width - dialogWidth) / 2
            dialogX = if(0 > i) 0 else i
        }
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        ...
        if (reactionText.visibility == View.VISIBLE) {
            ...
            val min = if(selectedView.layoutParams.size < reactionText.measuredHeight * 2) selectedView.layoutParams.size else reactionText.measuredHeight * 2
